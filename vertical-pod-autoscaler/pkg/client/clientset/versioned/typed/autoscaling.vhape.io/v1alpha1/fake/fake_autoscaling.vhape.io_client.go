...
import (
	v1alpha1 "k8s.io/autoscaler/vertical-pod-autoscaler/pkg/client/clientset/versioned/typed/autoscaling.vhape.io/v1alpha1"
	rest "k8s.io/client-go/rest"
	testing "k8s.io/client-go/testing"
)

type FakeVhapeAutoscalingV1alpha1 struct {
	*testing.Fake
}
...
func (c *FakeVhapeAutoscalingV1alpha1) VhapePolicies() v1alpha1.VhapePolicyInterface {
	return newFakeVhapePolicies(c)
}
...
func (c *FakeVhapeAutoscalingV1alpha1) RESTClient() rest.Interface {
