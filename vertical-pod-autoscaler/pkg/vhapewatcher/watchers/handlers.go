...
// Deployment spec changes do not affect the VPA generated by the watcher.
// If a Deployment is replaced with the same namespace/name and a new UID,
// the old generated VPA should be removed by Kubernetes garbage collection
// through ownerReferences. The VPA delete event will enqueue the Deployment
// again and the reconciler will create a new generated VPA if needed.
